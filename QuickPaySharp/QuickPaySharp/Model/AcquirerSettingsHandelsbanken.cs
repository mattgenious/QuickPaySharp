...
namespace QuickPaySharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AcquirerSettingsHandelsbanken :  IEquatable<AcquirerSettingsHandelsbanken>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AcquirerSettingsHandelsbanken" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AcquirerSettingsHandelsbanken);
        }

        /// <summary>
        /// Returns true if AcquirerSettingsHandelsbanken instances are equal
        /// </summary>
        /// <param name="input">Instance of AcquirerSettingsHandelsbanken to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AcquirerSettingsHandelsbanken input)
        {
            if (input == null)
                return false;
