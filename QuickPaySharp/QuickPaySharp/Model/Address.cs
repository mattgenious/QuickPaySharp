...
namespace QuickPaySharp.Model
{
    ...
    public partial class Address :  IEquatable<Address>, IValidatableObject
    {
        ...
        public Address(string att = default(string), string city = default(string), string countryCode = default(string), string name = default(string), string region = default(string), string street = default(string), string vatNo = default(string), string zipCode = default(string))
        {
            this.Att = att;
            this.City = city;
