...
namespace QuickPaySharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CardOperation :  IEquatable<CardOperation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CardOperation" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CardOperation);
        }

        /// <summary>
        /// Returns true if CardOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of CardOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CardOperation input)
        {
            if (input == null)
                return false;
