...
namespace QuickPaySharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FraudFilterRule :  IEquatable<FraudFilterRule>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FraudFilterRule" /> class.
        /// </summary>
        ...
        public FraudFilterRule(string metricName = default(string), string _operator = default(string), string value = default(string))
        {
        ...
        {
            return this.Equals(input as FraudFilterRule);
        }

        /// <summary>
        /// Returns true if FraudFilterRule instances are equal
        /// </summary>
        /// <param name="input">Instance of FraudFilterRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FraudFilterRule input)
        {
            if (input == null)
                return false;
