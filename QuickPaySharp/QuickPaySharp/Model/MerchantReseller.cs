...
namespace QuickPaySharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MerchantReseller :  IEquatable<MerchantReseller>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MerchantReseller" /> class.
        /// </summary>
        ...
        public MerchantReseller(int? defaultBrandingId = default(int?), string defaultPaymentMethods = default(string), int? id = default(int?), string name = default(string), string supportEmail = default(string))
        {
        ...
        {
            return this.Equals(input as MerchantReseller);
        }

        /// <summary>
        /// Returns true if MerchantReseller instances are equal
        /// </summary>
        /// <param name="input">Instance of MerchantReseller to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MerchantReseller input)
        {
            if (input == null)
                return false;
