# IO.Swagger.Model.AcquirerSettingsSwedbank
## Properties
...
**BusinessCode** | **string** | Swedbank business code | [optional] 
**Dinersclub** | **bool?** | True if Diners Club is enabled | [optional] 
**IdentificationCode** | **string** | Swedbank identification number | [optional] 
**IdentificationCodeInt** | **string** | Swedbank international identification number | [optional] 
**MastercardBin** | **string** | Swedbank Mastercard acquirer bin used for 3D Secure | [optional] 
...
**VisaBin** | **string** | Swedbank VISA acquirer bin used for 3D Secure | [optional] 
