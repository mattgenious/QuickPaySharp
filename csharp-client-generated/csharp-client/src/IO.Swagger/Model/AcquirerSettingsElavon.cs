...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AcquirerSettingsElavon :  IEquatable<AcquirerSettingsElavon>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AcquirerSettingsElavon" /> class.
        /// </summary>
        ...
        public AcquirerSettingsElavon(bool? active = default(bool?), bool? americanexpress = default(bool?), string businessCode = default(string), bool? dinersclub = default(bool?), string identificationCode = default(string), string identificationCodeInt = default(string), string mastercardBin = default(string), string mastercardMpiMerchantId = default(string), bool? recurring = default(bool?), bool? securepay = default(bool?), string visaBin = default(string), string visaMpiMerchantId = default(string))
        {
            this.Active = active;
        ...
        {
            return this.Equals(input as AcquirerSettingsElavon);
        }

        /// <summary>
        /// Returns true if AcquirerSettingsElavon instances are equal
        /// </summary>
        /// <param name="input">Instance of AcquirerSettingsElavon to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AcquirerSettingsElavon input)
        {
            if (input == null)
                return false;
