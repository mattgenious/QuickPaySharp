...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AcquirerSettingsNets :  IEquatable<AcquirerSettingsNets>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AcquirerSettingsNets" /> class.
        /// </summary>
        ...
        public AcquirerSettingsNets(bool? active = default(bool?), bool? americanexpress = default(bool?), string businessCode = default(string), bool? dinersclub = default(bool?), bool? fbg1886 = default(bool?), string identificationCode = default(string), string identificationCodeInt = default(string), string mastercardBin = default(string), string mastercardMpiMerchantId = default(string), bool? recurring = default(bool?), bool? securedByNets = default(bool?), bool? securepay = default(bool?), string visaBin = default(string), string visaMpiMerchantId = default(string))
        {
            this.Active = active;
        ...
        {
            return this.Equals(input as AcquirerSettingsNets);
        }

        /// <summary>
        /// Returns true if AcquirerSettingsNets instances are equal
        /// </summary>
        /// <param name="input">Instance of AcquirerSettingsNets to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AcquirerSettingsNets input)
        {
            if (input == null)
                return false;
