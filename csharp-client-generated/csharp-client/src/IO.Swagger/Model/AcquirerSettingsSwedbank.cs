...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AcquirerSettingsSwedbank :  IEquatable<AcquirerSettingsSwedbank>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AcquirerSettingsSwedbank" /> class.
        /// </summary>
        ...
        public AcquirerSettingsSwedbank(bool? active = default(bool?), bool? americanexpress = default(bool?), string businessCode = default(string), bool? dinersclub = default(bool?), string identificationCode = default(string), string identificationCodeInt = default(string), string mastercardBin = default(string), string mastercardMpiMerchantId = default(string), bool? recurring = default(bool?), bool? securepay = default(bool?), string visaBin = default(string), string visaMpiMerchantId = default(string))
        {
            this.Active = active;
        ...
        {
            return this.Equals(input as AcquirerSettingsSwedbank);
        }

        /// <summary>
        /// Returns true if AcquirerSettingsSwedbank instances are equal
        /// </summary>
        /// <param name="input">Instance of AcquirerSettingsSwedbank to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AcquirerSettingsSwedbank input)
        {
            if (input == null)
                return false;
