...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AcquirerSettingsTrustly :  IEquatable<AcquirerSettingsTrustly>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AcquirerSettingsTrustly" /> class.
        /// </summary>
        ...
        public AcquirerSettingsTrustly(bool? active = default(bool?), bool? ideal = default(bool?), string password = default(string), string username = default(string))
        {
            this.Active = active;
            this.Ideal = ideal;
        ...
        {
            return this.Equals(input as AcquirerSettingsTrustly);
        }

        /// <summary>
        /// Returns true if AcquirerSettingsTrustly instances are equal
        /// </summary>
        /// <param name="input">Instance of AcquirerSettingsTrustly to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AcquirerSettingsTrustly input)
        {
            if (input == null)
                return false;
