...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AcquirerSettingsVipps :  IEquatable<AcquirerSettingsVipps>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AcquirerSettingsVipps" /> class.
        /// </summary>
        ...
        public AcquirerSettingsVipps(string accessTokenSubscriptionKey = default(string), bool? active = default(bool?), string clientId = default(string), string clientSecret = default(string), string ecommerceSubscriptionKey = default(string), string orgno = default(string), string serialNumber = default(string))
        {
        ...
        {
            return this.Equals(input as AcquirerSettingsVipps);
        }

        /// <summary>
        /// Returns true if AcquirerSettingsVipps instances are equal
        /// </summary>
        /// <param name="input">Instance of AcquirerSettingsVipps to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AcquirerSettingsVipps input)
        {
            if (input == null)
                return false;
