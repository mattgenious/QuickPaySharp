...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FeeFormula :  IEquatable<FeeFormula>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeeFormula" /> class.
        /// </summary>
        /// <param name="acquirer">Acquirer.</param>
        /// <param name="formula">The formula.</param>
        /// <param name="paymentMethod">Payment method.</param>
        /// <param name="standard">True if this is the standard fee formula.</param>
        public FeeFormula(string acquirer = default(string), string formula = default(string), string paymentMethod = default(string), bool? standard = default(bool?))
        {
        ...
        {
            return this.Equals(input as FeeFormula);
        }

        /// <summary>
        /// Returns true if FeeFormula instances are equal
        /// </summary>
        /// <param name="input">Instance of FeeFormula to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FeeFormula input)
        {
            if (input == null)
                return false;
