...
namespace IO.Swagger.Model
{
    ...
    public partial class Metadata :  IEquatable<Metadata>, IValidatableObject
    {
        ...
        public Metadata(string bin = default(string), string brand = default(string), bool? corporate = default(bool?), string country = default(string), string customerCountry = default(string), string customerIp = default(string), int? expMonth = default(int?), int? expYear = default(int?), List<string> fraudRemarks = default(List<string>), string fraudReportDescription = default(string), bool? fraudReported = default(bool?), string fraudReportedAt = default(string), bool? fraudSuspected = default(bool?), string hash = default(string), string is3dSecure = default(string), string issuedTo = default(string), string last4 = default(string), string ninCountryCode = default(string), string ninGender = default(string), string ninNumber = default(string), string number = default(string), string origin = default(string), string shopsystemName = default(string), string shopsystemVersion = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Bin = bin;
            this.Brand = brand;
