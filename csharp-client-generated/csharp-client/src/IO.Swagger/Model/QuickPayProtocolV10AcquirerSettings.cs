...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10AcquirerSettings :  IEquatable<QuickPayProtocolV10AcquirerSettings>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10AcquirerSettings" /> class.
        /// </summary>
        ...
        public QuickPayProtocolV10AcquirerSettings(QuickPayProtocolV10AcquirerSettingsBambora bambora = default(QuickPayProtocolV10AcquirerSettingsBambora), QuickPayProtocolV10AcquirerSettingsClearhaus clearhaus = default(QuickPayProtocolV10AcquirerSettingsClearhaus), QuickPayProtocolV10AcquirerSettingsCoinify coinify = default(QuickPayProtocolV10AcquirerSettingsCoinify), QuickPayProtocolV10AcquirerSettingsElavon elavon = default(QuickPayProtocolV10AcquirerSettingsElavon), QuickPayProtocolV10AcquirerSettingsHandelsbanken handelsbanken = default(QuickPayProtocolV10AcquirerSettingsHandelsbanken), QuickPayProtocolV10AcquirerSettingsKlarna klarna = default(QuickPayProtocolV10AcquirerSettingsKlarna), QuickPayProtocolV10AcquirerSettingsKlarnaPayments klarnapayments = default(QuickPayProtocolV10AcquirerSettingsKlarnaPayments), QuickPayProtocolV10AcquirerSettingsMobilePay mobilepay = default(QuickPayProtocolV10AcquirerSettingsMobilePay), QuickPayProtocolV10AcquirerSettingsMobilePayOnline mobilepayonline = default(QuickPayProtocolV10AcquirerSettingsMobilePayOnline), QuickPayProtocolV10AcquirerSettingsMobilePaySubscriptions mobilepaysubscriptions = default(QuickPayProtocolV10AcquirerSettingsMobilePaySubscriptions), QuickPayProtocolV10AcquirerSettingsNets nets = default(QuickPayProtocolV10AcquirerSettingsNets), QuickPayProtocolV10AcquirerSettingsPayPal paypal = default(QuickPayProtocolV10AcquirerSettingsPayPal), QuickPayProtocolV10AcquirerSettingsPaysafecard paysafecard = default(QuickPayProtocolV10AcquirerSettingsPaysafecard), QuickPayProtocolV10AcquirerSettingsResurs resurs = default(QuickPayProtocolV10AcquirerSettingsResurs), QuickPayProtocolV10AcquirerSettingsSofort sofort = default(QuickPayProtocolV10AcquirerSettingsSofort), QuickPayProtocolV10AcquirerSettingsSwedbank swedbank = default(QuickPayProtocolV10AcquirerSettingsSwedbank), QuickPayProtocolV10AcquirerSettingsSwish swish = default(QuickPayProtocolV10AcquirerSettingsSwish), QuickPayProtocolV10AcquirerSettingsTeller teller = default(QuickPayProtocolV10AcquirerSettingsTeller), QuickPayProtocolV10AcquirerSettingsTrustly trustly = default(QuickPayProtocolV10AcquirerSettingsTrustly), QuickPayProtocolV10AcquirerSettingsValitor valitor = default(QuickPayProtocolV10AcquirerSettingsValitor), QuickPayProtocolV10AcquirerSettingsViaBill viabill = default(QuickPayProtocolV10AcquirerSettingsViaBill), QuickPayProtocolV10AcquirerSettingsVipps vipps = default(QuickPayProtocolV10AcquirerSettingsVipps))
        {
        ...
        {
            return this.Equals(input as QuickPayProtocolV10AcquirerSettings);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10AcquirerSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10AcquirerSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10AcquirerSettings input)
        {
            if (input == null)
                return false;
