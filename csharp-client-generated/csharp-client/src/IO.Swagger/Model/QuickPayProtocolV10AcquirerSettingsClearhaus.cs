...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10AcquirerSettingsClearhaus :  IEquatable<QuickPayProtocolV10AcquirerSettingsClearhaus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10AcquirerSettingsClearhaus" /> class.
        /// </summary>
        ...
        public QuickPayProtocolV10AcquirerSettingsClearhaus(bool? active = default(bool?), string apiKey = default(string), bool? applePay = default(bool?), string businessCode = default(string), string mpiMerchantId = default(string), bool? payout = default(bool?), bool? recurring = default(bool?))
        {
            this.Active = active;
            this.ApiKey = apiKey;
        ...
        {
            return this.Equals(input as QuickPayProtocolV10AcquirerSettingsClearhaus);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10AcquirerSettingsClearhaus instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10AcquirerSettingsClearhaus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10AcquirerSettingsClearhaus input)
        {
            if (input == null)
                return false;
