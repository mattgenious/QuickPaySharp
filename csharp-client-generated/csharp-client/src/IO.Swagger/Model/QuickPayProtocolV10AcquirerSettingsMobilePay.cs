...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10AcquirerSettingsMobilePay :  IEquatable<QuickPayProtocolV10AcquirerSettingsMobilePay>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10AcquirerSettingsMobilePay" /> class.
        /// </summary>
        ...
        public QuickPayProtocolV10AcquirerSettingsMobilePay(bool? active = default(bool?), string deliveryLimitedTo = default(string))
        {
            this.Active = active;
        ...
        {
            return this.Equals(input as QuickPayProtocolV10AcquirerSettingsMobilePay);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10AcquirerSettingsMobilePay instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10AcquirerSettingsMobilePay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10AcquirerSettingsMobilePay input)
        {
            if (input == null)
                return false;
