...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10AcquirerSettingsMobilePaySubscriptions :  IEquatable<QuickPayProtocolV10AcquirerSettingsMobilePaySubscriptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10AcquirerSettingsMobilePaySubscriptions" /> class.
        /// </summary>
        ...
        public QuickPayProtocolV10AcquirerSettingsMobilePaySubscriptions(bool? active = default(bool?), string authState = default(string), string codeVerifier = default(string), int? lastTokenRefresh = default(int?), string nonce = default(string), int? pendingStatus = default(int?), Object provider = default(Object), string refreshToken = default(string))
        {
            this.Active = active;
        ...
        {
            return this.Equals(input as QuickPayProtocolV10AcquirerSettingsMobilePaySubscriptions);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10AcquirerSettingsMobilePaySubscriptions instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10AcquirerSettingsMobilePaySubscriptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10AcquirerSettingsMobilePaySubscriptions input)
        {
            if (input == null)
                return false;
