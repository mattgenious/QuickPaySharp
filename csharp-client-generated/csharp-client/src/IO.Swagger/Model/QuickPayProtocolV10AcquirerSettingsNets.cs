...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10AcquirerSettingsNets :  IEquatable<QuickPayProtocolV10AcquirerSettingsNets>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10AcquirerSettingsNets" /> class.
        /// </summary>
        /// <param name="active">True if the acquirer is active.</param>
        /// <param name="americanexpress">(Depricated use Teller acquirer).</param>
        /// <param name="businessCode">Nets business code.</param>
        /// <param name="dinersclub">(Depricated use Teller acquirer).</param>
        /// <param name="fbg1886">True if Forbrugsforeningen is enabled.</param>
        /// <param name="identificationCode">Nets identification code.</param>
        ...
        /// <param name="mastercardMpiMerchantId">(Depricated use Teller acquirer).</param>
        /// <param name="recurring">True if recurring is enabled.</param>
        /// <param name="securedByNets">True if SecuredByNets is enabled.</param>
        /// <param name="securepay">(Depricated use Teller acquirer).</param>
        /// <param name="visaBin">(Depricated use Teller acquirer).</param>
        /// <param name="visaMpiMerchantId">(Depricated use Teller acquirer).</param>
        public QuickPayProtocolV10AcquirerSettingsNets(bool? active = default(bool?), bool? americanexpress = default(bool?), string businessCode = default(string), bool? dinersclub = default(bool?), bool? fbg1886 = default(bool?), string identificationCode = default(string), string identificationCodeInt = default(string), string mastercardBin = default(string), string mastercardMpiMerchantId = default(string), bool? recurring = default(bool?), bool? securedByNets = default(bool?), bool? securepay = default(bool?), string visaBin = default(string), string visaMpiMerchantId = default(string))
        {
            this.Active = active;
        ...
        {
            return this.Equals(input as QuickPayProtocolV10AcquirerSettingsNets);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10AcquirerSettingsNets instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10AcquirerSettingsNets to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10AcquirerSettingsNets input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SecuredByNets == input.SecuredByNets ||
                    (this.SecuredByNets != null &&
                    this.SecuredByNets.Equals(input.SecuredByNets))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SecuredByNets != null)
                    hashCode = hashCode * 59 + this.SecuredByNets.GetHashCode();
