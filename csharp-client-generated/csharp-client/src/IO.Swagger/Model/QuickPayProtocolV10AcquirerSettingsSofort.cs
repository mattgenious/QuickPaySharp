...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10AcquirerSettingsSofort :  IEquatable<QuickPayProtocolV10AcquirerSettingsSofort>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10AcquirerSettingsSofort" /> class.
        /// </summary>
        ...
        public QuickPayProtocolV10AcquirerSettingsSofort(bool? active = default(bool?), string apiKey = default(string), int? customerNumber = default(int?), bool? gateway = default(bool?), bool? ideal = default(bool?), string idealNotificationPassword = default(string), int? idealProjectId = default(int?), string idealProjectPassword = default(string), int? projectId = default(int?))
        {
            this.Active = active;
            this.ApiKey = apiKey;
        ...
        {
            return this.Equals(input as QuickPayProtocolV10AcquirerSettingsSofort);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10AcquirerSettingsSofort instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10AcquirerSettingsSofort to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10AcquirerSettingsSofort input)
        {
            if (input == null)
                return false;
