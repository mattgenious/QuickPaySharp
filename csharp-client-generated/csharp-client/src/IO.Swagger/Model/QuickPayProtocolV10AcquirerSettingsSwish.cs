...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10AcquirerSettingsSwish :  IEquatable<QuickPayProtocolV10AcquirerSettingsSwish>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10AcquirerSettingsSwish" /> class.
        /// </summary>
        ...
        public QuickPayProtocolV10AcquirerSettingsSwish(bool? active = default(bool?), int? cryptographyKeyId = default(int?), string merchantId = default(string))
        {
            this.Active = active;
        ...
        {
            return this.Equals(input as QuickPayProtocolV10AcquirerSettingsSwish);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10AcquirerSettingsSwish instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10AcquirerSettingsSwish to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10AcquirerSettingsSwish input)
        {
            if (input == null)
                return false;
