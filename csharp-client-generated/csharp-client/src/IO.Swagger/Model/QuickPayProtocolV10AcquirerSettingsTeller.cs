...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10AcquirerSettingsTeller :  IEquatable<QuickPayProtocolV10AcquirerSettingsTeller>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10AcquirerSettingsTeller" /> class.
        /// </summary>
        ...
        /// <param name="businessCode">Teller business code.</param>
        ...
        public QuickPayProtocolV10AcquirerSettingsTeller(bool? active = default(bool?), bool? americanexpress = default(bool?), string businessCode = default(string), bool? dinersclub = default(bool?), string identificationCode = default(string), string identificationCodeInt = default(string), string mastercardBin = default(string), string mastercardMpiMerchantId = default(string), bool? recurring = default(bool?), bool? securepay = default(bool?), string visaBin = default(string), string visaMpiMerchantId = default(string))
        {
            this.Active = active;
        ...
        {
            return this.Equals(input as QuickPayProtocolV10AcquirerSettingsTeller);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10AcquirerSettingsTeller instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10AcquirerSettingsTeller to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10AcquirerSettingsTeller input)
        {
            if (input == null)
                return false;
