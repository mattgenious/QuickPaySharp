...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10AcquirerStatus :  IEquatable<QuickPayProtocolV10AcquirerStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10AcquirerStatus" /> class.
        /// </summary>
        ...
        public QuickPayProtocolV10AcquirerStatus(string acquirer = default(string), int? health = default(int?), string status = default(string))
        {
        ...
        {
            return this.Equals(input as QuickPayProtocolV10AcquirerStatus);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10AcquirerStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10AcquirerStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10AcquirerStatus input)
        {
            if (input == null)
                return false;
