...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10Activity :  IEquatable<QuickPayProtocolV10Activity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10Activity" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as QuickPayProtocolV10Activity);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10Activity instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10Activity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10Activity input)
        {
            if (input == null)
                return false;
