...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10Agreement :  IEquatable<QuickPayProtocolV10Agreement>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10Agreement" /> class.
        /// </summary>
        ...
        public QuickPayProtocolV10Agreement(bool? accepted = default(bool?), QuickPayProtocolV10AgreementAccount account = default(QuickPayProtocolV10AgreementAccount), List<QuickPayProtocolV10AclPermission> aclPermissions = default(List<QuickPayProtocolV10AclPermission>), string apiKey = default(string), DateTime? createdAt = default(DateTime?), string description = default(string), int? id = default(int?), List<QuickPayProtocolV10IPRestriction> ipRestriction = default(List<QuickPayProtocolV10IPRestriction>), bool? locked = default(bool?), bool? owner = default(bool?), string service = default(string), bool? support = default(bool?), QuickPayProtocolV10AgreementUser user = default(QuickPayProtocolV10AgreementUser))
        {
        ...
        {
            return this.Equals(input as QuickPayProtocolV10Agreement);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10Agreement instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10Agreement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10Agreement input)
        {
            if (input == null)
                return false;
