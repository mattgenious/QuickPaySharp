...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10AgreementUser :  IEquatable<QuickPayProtocolV10AgreementUser>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10AgreementUser" /> class.
        /// </summary>
        ...
        public QuickPayProtocolV10AgreementUser(string email = default(string), int? id = default(int?), string name = default(string), bool? systemUser = default(bool?))
        {
            this.Email = email;
            this.Id = id;
            this.Name = name;
        ...
        {
            return this.Equals(input as QuickPayProtocolV10AgreementUser);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10AgreementUser instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10AgreementUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10AgreementUser input)
        {
            if (input == null)
                return false;
