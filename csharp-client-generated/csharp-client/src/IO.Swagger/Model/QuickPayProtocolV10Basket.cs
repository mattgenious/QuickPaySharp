...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10Basket :  IEquatable<QuickPayProtocolV10Basket>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10Basket" /> class.
        /// </summary>
        ...
        public QuickPayProtocolV10Basket(string itemName = default(string), string itemNo = default(string), int? itemPrice = default(int?), int? qty = default(int?), float? vatRate = default(float?))
        {
        ...
        {
            return this.Equals(input as QuickPayProtocolV10Basket);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10Basket instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10Basket to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10Basket input)
        {
            if (input == null)
                return false;
