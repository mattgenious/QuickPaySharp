...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10Card :  IEquatable<QuickPayProtocolV10Card>, IValidatableObject
    {
        /// <summary>
        /// Type of transaction
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10Card" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QuickPayProtocolV10Card() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10Card" /> class.
        /// </summary>
        ...
        public QuickPayProtocolV10Card(bool? accepted = default(bool?), string acquirer = default(string), DateTime? createdAt = default(DateTime?), int? id = default(int?), QuickPayProtocolV10CardLink link = default(QuickPayProtocolV10CardLink), int? merchantId = default(int?), QuickPayProtocolV10Metadata metadata = default(QuickPayProtocolV10Metadata), List<QuickPayProtocolV10CardOperation> operations = default(List<QuickPayProtocolV10CardOperation>), bool? testMode = default(bool?), TypeEnum? type = default(TypeEnum?), Dictionary<string, string> variables = default(Dictionary<string, string>))
        {
            // to ensure "variables" is required (not null)
            if (variables == null)
            {
                throw new InvalidDataException("variables is a required property for QuickPayProtocolV10Card and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as QuickPayProtocolV10Card);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10Card instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10Card to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10Card input)
        {
            if (input == null)
                return false;
