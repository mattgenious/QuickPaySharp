...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10CardLink :  IEquatable<QuickPayProtocolV10CardLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10CardLink" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as QuickPayProtocolV10CardLink);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10CardLink instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10CardLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10CardLink input)
        {
            if (input == null)
                return false;
