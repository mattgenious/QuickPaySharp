...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10CardOperation :  IEquatable<QuickPayProtocolV10CardOperation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10CardOperation" /> class.
        /// </summary>
        ...
        public QuickPayProtocolV10CardOperation(string acquirer = default(string), string aqStatusCode = default(string), string aqStatusMsg = default(string), DateTime? callbackAt = default(DateTime?), int? callbackDuration = default(int?), bool? callbackResponseCode = default(bool?), bool? callbackSuccess = default(bool?), string callbackUrl = default(string), DateTime? createdAt = default(DateTime?), int? id = default(int?), bool? pending = default(bool?), string qpStatusCode = default(string), string qpStatusMsg = default(string), string type = default(string))
        {
        ...
        {
            return this.Equals(input as QuickPayProtocolV10CardOperation);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10CardOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10CardOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10CardOperation input)
        {
            if (input == null)
                return false;
