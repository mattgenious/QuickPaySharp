...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10FraudRuleset :  IEquatable<QuickPayProtocolV10FraudRuleset>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10FraudRuleset" /> class.
        /// </summary>
        ...
        public QuickPayProtocolV10FraudRuleset(string action = default(string), string combinator = default(string), List<QuickPayProtocolV10FraudFilterRule> filterRules = default(List<QuickPayProtocolV10FraudFilterRule>), int? id = default(int?), int? merchantId = default(int?), string name = default(string))
        {
            this.Action = action;
        ...
        {
            return this.Equals(input as QuickPayProtocolV10FraudRuleset);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10FraudRuleset instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10FraudRuleset to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10FraudRuleset input)
        {
            if (input == null)
                return false;
