...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10IntegrationSettingsEconomic :  IEquatable<QuickPayProtocolV10IntegrationSettingsEconomic>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10IntegrationSettingsEconomic" /> class.
        /// </summary>
        ...
        public QuickPayProtocolV10IntegrationSettingsEconomic(bool? active = default(bool?), string agreement = default(string), string agreementToken = default(string))
        {
            this.Active = active;
        ...
        {
            return this.Equals(input as QuickPayProtocolV10IntegrationSettingsEconomic);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10IntegrationSettingsEconomic instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10IntegrationSettingsEconomic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10IntegrationSettingsEconomic input)
        {
            if (input == null)
                return false;
