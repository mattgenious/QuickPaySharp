...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10MerchantCryptographyKey :  IEquatable<QuickPayProtocolV10MerchantCryptographyKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10MerchantCryptographyKey" /> class.
        /// </summary>
        ...
        public QuickPayProtocolV10MerchantCryptographyKey(DateTime? certificateExpiresAt = default(DateTime?), DateTime? createdAt = default(DateTime?), int? id = default(int?), string publicKeyHash = default(string), string shortDescription = default(string), string type = default(string), DateTime? updatedAt = default(DateTime?))
        {
        ...
        {
            return this.Equals(input as QuickPayProtocolV10MerchantCryptographyKey);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10MerchantCryptographyKey instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10MerchantCryptographyKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10MerchantCryptographyKey input)
        {
            if (input == null)
                return false;
