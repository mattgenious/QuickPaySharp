...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10Operation :  IEquatable<QuickPayProtocolV10Operation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10Operation" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as QuickPayProtocolV10Operation);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10Operation instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10Operation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10Operation input)
        {
            if (input == null)
                return false;
