...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10OptionalAddress :  IEquatable<QuickPayProtocolV10OptionalAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10OptionalAddress" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as QuickPayProtocolV10OptionalAddress);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10OptionalAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10OptionalAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10OptionalAddress input)
        {
            if (input == null)
                return false;
