...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10PaymentLink :  IEquatable<QuickPayProtocolV10PaymentLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10PaymentLink" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as QuickPayProtocolV10PaymentLink);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10PaymentLink instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10PaymentLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10PaymentLink input)
        {
            if (input == null)
                return false;
