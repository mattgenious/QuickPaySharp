...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10Payout :  IEquatable<QuickPayProtocolV10Payout>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10Payout" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QuickPayProtocolV10Payout() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10Payout" /> class.
        /// </summary>
        ...
        public QuickPayProtocolV10Payout(bool? accepted = default(bool?), string acquirer = default(string), int? balance = default(int?), int? brandingId = default(int?), DateTime? createdAt = default(DateTime?), string currency = default(string), string facilitator = default(string), int? id = default(int?), QuickPayProtocolV10PaymentLink link = default(QuickPayProtocolV10PaymentLink), int? merchantId = default(int?), QuickPayProtocolV10Metadata metadata = default(QuickPayProtocolV10Metadata), List<QuickPayProtocolV10Operation> operations = default(List<QuickPayProtocolV10Operation>), string orderId = default(string), DateTime? retentedAt = default(DateTime?), StateEnum? state = default(StateEnum?), bool? testMode = default(bool?), string textOnStatement = default(string), string type = default(string), DateTime? updatedAt = default(DateTime?), Dictionary<string, string> variables = default(Dictionary<string, string>))
        {
            // to ensure "brandingId" is required (not null)
            if (brandingId == null)
            {
                throw new InvalidDataException("brandingId is a required property for QuickPayProtocolV10Payout and cannot be null");
            }
            else
            {
            ...
            if (variables == null)
            {
                throw new InvalidDataException("variables is a required property for QuickPayProtocolV10Payout and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as QuickPayProtocolV10Payout);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10Payout instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10Payout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10Payout input)
        {
            if (input == null)
                return false;
