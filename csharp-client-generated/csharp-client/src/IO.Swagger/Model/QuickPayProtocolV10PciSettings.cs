...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10PciSettings :  IEquatable<QuickPayProtocolV10PciSettings>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10PciSettings" /> class.
        /// </summary>
        ...
        public QuickPayProtocolV10PciSettings(bool? saqA = default(bool?), bool? saqAEp = default(bool?), bool? saqB = default(bool?), bool? saqBIp = default(bool?), bool? saqC = default(bool?), bool? saqCVt = default(bool?), bool? saqDMerchant = default(bool?), bool? saqDServiceProvider = default(bool?), bool? saqP2peHw = default(bool?))
        {
            this.SaqA = saqA;
            this.SaqAEp = saqAEp;
            this.SaqB = saqB;
        ...
        {
            return this.Equals(input as QuickPayProtocolV10PciSettings);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10PciSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10PciSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10PciSettings input)
        {
            if (input == null)
                return false;
