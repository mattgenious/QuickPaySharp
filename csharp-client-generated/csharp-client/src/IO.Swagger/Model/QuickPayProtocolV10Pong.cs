...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10Pong :  IEquatable<QuickPayProtocolV10Pong>, IValidatableObject
    {
        /// <summary>
        /// API scope
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10Pong" /> class.
        /// </summary>
        ...
        public QuickPayProtocolV10Pong(string msg = default(string), Dictionary<string, string> _params = default(Dictionary<string, string>), ScopeEnum? scope = default(ScopeEnum?), string version = default(string))
        {
            this.Msg = msg;
            this.Params = _params;
            this.Scope = scope;
        ...
        {
            return this.Equals(input as QuickPayProtocolV10Pong);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10Pong instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10Pong to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10Pong input)
        {
            if (input == null)
                return false;
