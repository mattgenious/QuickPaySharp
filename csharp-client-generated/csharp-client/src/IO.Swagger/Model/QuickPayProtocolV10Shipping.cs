...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10Shipping :  IEquatable<QuickPayProtocolV10Shipping>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10Shipping" /> class.
        /// </summary>
        ...
        public QuickPayProtocolV10Shipping(int? amount = default(int?), string company = default(string), string method = default(string), string trackingNumber = default(string), string trackingUrl = default(string), float? vatRate = default(float?))
        {
            this.Amount = amount;
        ...
        {
            return this.Equals(input as QuickPayProtocolV10Shipping);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10Shipping instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10Shipping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10Shipping input)
        {
            if (input == null)
                return false;
