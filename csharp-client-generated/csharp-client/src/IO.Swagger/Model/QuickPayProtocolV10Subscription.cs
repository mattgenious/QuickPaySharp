...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickPayProtocolV10Subscription :  IEquatable<QuickPayProtocolV10Subscription>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10Subscription" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QuickPayProtocolV10Subscription() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickPayProtocolV10Subscription" /> class.
        /// </summary>
        ...
        public QuickPayProtocolV10Subscription(bool? accepted = default(bool?), string acquirer = default(string), QuickPayProtocolV10Basket basket = default(QuickPayProtocolV10Basket), int? brandingId = default(int?), DateTime? createdAt = default(DateTime?), string currency = default(string), DateTime? deadlineAt = default(DateTime?), string description = default(string), string facilitator = default(string), List<int?> groupIds = default(List<int?>), int? id = default(int?), QuickPayProtocolV10OptionalAddress invoiceAddress = default(QuickPayProtocolV10OptionalAddress), QuickPayProtocolV10PaymentLink link = default(QuickPayProtocolV10PaymentLink), int? merchantId = default(int?), QuickPayProtocolV10Metadata metadata = default(QuickPayProtocolV10Metadata), List<QuickPayProtocolV10Operation> operations = default(List<QuickPayProtocolV10Operation>), string orderId = default(string), DateTime? retentedAt = default(DateTime?), QuickPayProtocolV10Shipping shipping = default(QuickPayProtocolV10Shipping), QuickPayProtocolV10OptionalAddress shippingAddress = default(QuickPayProtocolV10OptionalAddress), StateEnum? state = default(StateEnum?), bool? testMode = default(bool?), string textOnStatement = default(string), string type = default(string), DateTime? updatedAt = default(DateTime?), Dictionary<string, string> variables = default(Dictionary<string, string>))
        {
            // to ensure "brandingId" is required (not null)
            if (brandingId == null)
            {
                throw new InvalidDataException("brandingId is a required property for QuickPayProtocolV10Subscription and cannot be null");
            }
            else
            {
            ...
            if (variables == null)
            {
                throw new InvalidDataException("variables is a required property for QuickPayProtocolV10Subscription and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as QuickPayProtocolV10Subscription);
        }

        /// <summary>
        /// Returns true if QuickPayProtocolV10Subscription instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickPayProtocolV10Subscription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickPayProtocolV10Subscription input)
        {
            if (input == null)
                return false;
