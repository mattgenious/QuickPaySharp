...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class QuickPayProtocolV10Agreement {
    /// <summary>
    ...
    public QuickPayProtocolV10AgreementAccount Account { get; set; }
    ...
    public List<QuickPayProtocolV10AclPermission> AclPermissions { get; set; }
    ...
    public List<QuickPayProtocolV10IPRestriction> IpRestriction { get; set; }
    ...
    public QuickPayProtocolV10AgreementUser User { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class QuickPayProtocolV10Agreement {\n");
