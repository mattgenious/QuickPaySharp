...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class QuickPayProtocolV10Card {
    /// <summary>
    ...
    public QuickPayProtocolV10CardLink Link { get; set; }
    ...
    public List<QuickPayProtocolV10CardOperation> Operations { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class QuickPayProtocolV10Card {\n");
